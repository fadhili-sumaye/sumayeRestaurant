...
public class SecurityConfig {
    ...
    @Value("${app.cors.allowed-origins:http://localhost:3000,http://localhost:8080,http://10.0.2.2:8080,http://192.168.1.25:8080}")
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers("/api/auth/login", "/api/auth/health", "/api/health", "/api/health/**", "/api/public/**", "/ws/**", "/images/**", "/error").permitAll()
    ...
    /**
     * DaoAuthenticationProvider wires the UserDetailsService + PasswordEncoder together.
     * This is what allows AuthenticationManager to authenticate username/password credentials.
     */
    @Bean
